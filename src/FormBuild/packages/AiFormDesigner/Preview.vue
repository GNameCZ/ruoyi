/** *Copyright: Copyright (c) 2023 *Author:Leo *Version 1.0 *Title: form-generator/Element Plus 表单解析器 *GitHub:
https://github.com/leooneone/aibpm.ui.plus */
  ...
  <section v-if="state.isShow">
    <el-drawer v-model="state.isShow" direction="rtl" :size="state.drawerSize">
      <template #header="{ close, titleId, titleClass }">
        ...
        <el-button-group>
          <el-button icon="Cellphone" title="手机" @click="state.drawerSize = '390px'"> </el-button>

          <el-button icon="Monitor" title="电脑" @click="state.drawerSize = '100%'"></el-button>
        </el-button-group>
      </template>
      <form-parser ref="formRef" :conf="state.conf"></form-parser>
