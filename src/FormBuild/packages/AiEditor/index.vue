...
-->
<template>
  <div v-if="props.disabled" style="width: 100%" v-html="props.modelValue"></div>
  <textarea v-else :id="state.tinymceId" style="visibility: hidden; width: 100%" />
</template>
